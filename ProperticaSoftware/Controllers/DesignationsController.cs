...
namespace ProperticaSoftware.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Did,Name,IsActive")] Designation designation)
        {
            ...
            ViewBag.Did = new SelectList(db.Departments, "Id", "Name", designation.Did);
            return View(designation);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Did,Name,IsActive")] Designation designation)
        {
            if (ModelState.IsValid)
            {
